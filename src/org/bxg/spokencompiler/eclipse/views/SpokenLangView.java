package org.bxg.spokencompiler.eclipse.views;
...
import org.bxg.spokencompiler.eclipse.UpdateViewOp;
...
public class SpokenLangView extends ViewPart
{
	 ...
	 */
	public static final String ID = "org.bxg.spokencompiler.eclipse.views.SpokenLangView";
...
//		PlatformUI.getWorkbench().getHelpSystem().setHelp(viewer.getControl(), "org.bxg.spokencompiler.eclipse.viewer");
//		makeActions();
//		hookContextMenu();
